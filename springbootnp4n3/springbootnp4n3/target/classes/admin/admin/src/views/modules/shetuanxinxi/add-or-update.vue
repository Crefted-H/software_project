<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="集体名称" prop="shetuanmingcheng">
          <el-input v-model="ruleForm.shetuanmingcheng"
              placeholder="集体名称" clearable  :readonly="ro.shetuanmingcheng"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="集体名称" prop="shetuanmingcheng">
              <el-input v-model="ruleForm.shetuanmingcheng"
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="集体分类" prop="shetuanfenlei">
          <el-select v-model="ruleForm.shetuanfenlei" placeholder="请选择集体分类">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="集体分类" prop="shetuanfenlei">
	      <el-input v-model="ruleForm.shetuanfenlei"
                placeholder="集体分类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="集体姓名" prop="shezhangxingming">
          <el-input v-model="ruleForm.shezhangxingming"
              placeholder="集体姓名" clearable  :readonly="ro.shezhangxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="集体姓名" prop="shezhangxingming">
              <el-input v-model="ruleForm.shezhangxingming"
                placeholder="集体姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="集体简介" prop="shetuanjianjie">
                <editor
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.shetuanjianjie" label="集体简介" prop="shetuanjianjie">
...
export default {
  data() {
	...
	clicknum : false,
      ...
      rules: {
          shetuanmingcheng: [
                { required: true, message: '集体名称不能为空', trigger: 'blur' },
          ],
          shetuanfenlei: [
                { required: true, message: '集体分类不能为空', trigger: 'blur' },
          ],
          tupian: [
          ],
          chuangjianshijian: [
