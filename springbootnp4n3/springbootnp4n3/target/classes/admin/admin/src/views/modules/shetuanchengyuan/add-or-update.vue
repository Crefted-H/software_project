<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="标签" prop="banji">
          <el-input v-model="ruleForm.banji"
              placeholder="标签" clearable  :readonly="ro.banji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="标签" prop="banji">
              <el-input v-model="ruleForm.banji"
