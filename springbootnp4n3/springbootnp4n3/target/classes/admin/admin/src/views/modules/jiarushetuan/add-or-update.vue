<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="集体分类" prop="shetuanfenlei">
          <el-input v-model="ruleForm.shetuanfenlei"
              placeholder="集体分类" clearable  :readonly="ro.shetuanfenlei"></el-input>
        </el-form-item>
        <div v-else>
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="cn" prop="xuehao">
          <el-input v-model="ruleForm.xuehao"
              placeholder="cn" clearable  :readonly="ro.xuehao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="cn" prop="xuehao">
              <el-input v-model="ruleForm.xuehao"
                placeholder="cn" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="具体标签" prop="banji">
          <el-input v-model="ruleForm.banji"
              placeholder="具体标签" clearable  :readonly="ro.banji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="具体标签" prop="banji">
              <el-input v-model="ruleForm.banji"
                placeholder="具体标签" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
