<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="标签" prop="xueyuan">
          <el-input v-model="ruleForm.xueyuan"
              placeholder="标签" clearable  :readonly="ro.xueyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="标签" prop="xueyuan">
              <el-input v-model="ruleForm.xueyuan"
