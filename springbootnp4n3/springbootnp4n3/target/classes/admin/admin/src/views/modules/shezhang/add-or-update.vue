<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="集体名称" prop="shezhangxingming">
          <el-input v-model="ruleForm.shezhangxingming"
              placeholder="集体名称" clearable  :readonly="ro.shezhangxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="集体名称" prop="shezhangxingming">
              <el-input v-model="ruleForm.shezhangxingming"
                placeholder="集体名称" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>

      <el-col :span="12">
          <el-form-item class="input" v-if="type!='info'"  label="标签" prop="xingbie">
            <el-input v-model="ruleForm.xingbie"
                placeholder="标签" clearable  :readonly="ro.xingbie"></el-input>
          </el-form-item>
          <div v-else>
            <el-form-item class="input" label="标签" prop="xingbie">
                <el-input v-model="ruleForm.xingbie"
      ...
      <el-col :span="24">
        <el-form-item class="upload" v-if="type!='info' && !ro.touxiang" label="图片" prop="touxiang">
          <file-upload
          tip="点击上传图片"
          action="file/upload"
          :limit="3"
        ...
        <div v-else>
          <el-form-item v-if="ruleForm.touxiang" label="图片" prop="touxiang">
            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in ruleForm.touxiang.split(',')" :src="item" width="100" height="100">
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="具体详细" prop="xueyuan">
          <el-input v-model="ruleForm.xueyuan"
              placeholder="具体详细" clearable  :readonly="ro.xueyuan"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="具体详细" prop="xueyuan">
              <el-input v-model="ruleForm.xueyuan"
                placeholder="具体详细" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="交流方式" prop="banji">
          <el-input v-model="ruleForm.banji"
              placeholder="交流方式" clearable  :readonly="ro.banji"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="交流方式" prop="banji">
              <el-input v-model="ruleForm.banji"
                placeholder="交流方式" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
